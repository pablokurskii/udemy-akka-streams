...
object GraphMaterializedValues extends App {
  ...
  /**
   * Exercise - enhance a flow to return a materialized value - value - number of elements of original flow
   */
  ...
  val ech = simpleSource.viaMat(enhanceFlow(simpleFlow))(Keep.right).to(simpleSink).run()
  ech.onComplete{
